<template>
  ...
  <footer class="footer" role="contentinfo">
    <div class="l-constrain">
      <img class="footer__epa-seal" src="../../assets/styles/images/epa-seal.svg" alt="United States Environmental Protection Agency" height="100" width="100">
      <div class="footer__content contextual-region">
        ...
        <div class="footer__column">
          ...
          <ul class="menu menu--footer">
            ...
            <li class="menu__item">
              <a href="https://www.epa.gov/home/epa-hotlines" class="menu__link">Hotlines</a>
            </li>
            <li class="menu__item">
            ...
            <li class="menu__item">
              <a class="menu__link" aria-label="EPA’s Facebook" href="https://www.facebook.com/EPA">
                <svg class="icon icon--social" aria-hidden="true">
                  <use xlink:href="../../assets/styles/images//sprite.artifact.svg#facebook-square"></use>
                </svg> </a>
            </li>
            <li class="menu__item">
              <a class="menu__link" aria-label="EPA’s Twitter" href="https://twitter.com/epa">
                <svg class="icon icon--social" aria-hidden="true">
                  <use xlink:href="../../assets/styles/images/sprite.artifact.svg#twitter-square"></use>
                </svg> </a>
            </li>
            <li class="menu__item">
              <a class="menu__link" aria-label="EPA’s Youtube" href="https://www.youtube.com/user/USEPAgov">
                <svg class="icon icon--social" aria-hidden="true">
                  <use xlink:href="../../assets/styles/images/sprite.artifact.svg#youtube-square"></use>
                </svg> </a>
            </li>
            <li class="menu__item">
              <a class="menu__link" aria-label="EPA’s Flickr" href="https://www.flickr.com/photos/usepagov">
                <svg class="icon icon--social" aria-hidden="true">
                  <use xlink:href="../../assets/styles/images/sprite.artifact.svg#flickr-square"></use>
                </svg> </a>
            </li>
            <li class="menu__item">
              <a class="menu__link" aria-label="EPA’s Instagram" href="https://www.instagram.com/epagov">
                <svg class="icon icon--social" aria-hidden="true">
                  <use xlink:href="../../assets/styles/images/sprite.artifact.svg#instagram-square"></use>
                </svg> </a>
            </li>
          </ul>
          <p class="footer__last-updated">Last updated on September 21, 2022</p>
        </div>
